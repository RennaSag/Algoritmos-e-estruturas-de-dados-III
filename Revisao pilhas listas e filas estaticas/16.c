/*Crie uma função que receba uma lista encadeada de números inteiros e
retorne o número de elementos que são múltiplos de 3 e 5 ao mesmo
tempo*/
...
int main() {
    ...
    printf("\n\nMultiplos de 3 e 5: %d", multi35(lista));
